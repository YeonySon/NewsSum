package com.ssafy.newsum.global.jwt;
...
public class JwtAuthenticationProcessingFilter extends OncePerRequestFilter {
	...
	public void checkAccessTokenAndAuthentication(HttpServletRequest request, HttpServletResponse response,
		...
		jwtService.extractAccessToken(request)
			...
			.ifPresent(accessToken -> jwtService.extractUid(accessToken)
				.ifPresent(userEmail -> userRepository.findByEmail(userEmail)
	...
	public void saveAuthentication(User myUser) {
		...
		UserDetails userDetailsUser = org.springframework.security.core.userdetails.User.builder()
			.username(myUser.getEmail()) // String type이라서 uid 넣은 것!
			.password(password)
			// .authorities(authorities)
			.roles(myUser.getAuthenticate())
			.build();
