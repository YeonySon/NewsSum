...
function MyInfoComponent() {
  ...
  const [leaveModalOpen, setLeaveModalOpen] =
    useRecoilState(LeaveModalIsOpenAtom);
  ...
  const passwordWarningMessage = [
    ".",
    "사용 가능한 비밀번호입니다.",
    "8~16자의 영문, 숫자, 특수기호를 포함해 주세요.",
  ];

  const [checkPassword, setCheckPassword] = useState("");
  const checkPasswordWarningMessage = [
    ".",
    "확인되었습니다.",
    "비밀번호가 일치하지 않습니다.",
  ];
      ...
      <Container>
        ...
        <MyInfoBox>
          ...
          <MyInfoBoxInput
            ...
            placeholder="비밀번호 (8 ~ 16자의 영문, 숫자, 특수기호 포함)"
          />
        </MyInfoBox>
        <MyInfoWarningMessageTag
          $isNotActive={!passwordMessageType}
          $isSuccess={passwordMessageType === 1}
        >
        ...
        <MyInfoWarningMessageTag
          $isNotActive={!password || !checkPassword}
          $isSuccess={passwordIsCheck}
        >
          {passwordIsCheck
            ? checkPasswordWarningMessage[1]
            : checkPasswordWarningMessage[2]}
        </MyInfoWarningMessageTag>
        ...
        <MyInfoBox>
          ...
          <MyInfoBoxDiv>|</MyInfoBoxDiv>
          <MyInfoBoxContent>{`${formData.birthDate.slice(
            0,
            4
        ...
        <MyInfoBox>
          <MyInfoButton $isLeft={true} onClick={editCheck}>
            수정
          </MyInfoButton>
          <MyInfoButton $isLeft={false} onClick={leaveCheck}>
            탈퇴
          </MyInfoButton>
        </MyInfoBox>
      </Container>
